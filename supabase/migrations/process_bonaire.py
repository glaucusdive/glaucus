#!/usr/bin/env python3
"""
Process Bonaire dive shops CSV and generate SQL INSERT statements
"""
...
def process_bonaire_csv():
    """Process Bonaire CSV and generate SQL"""
    
    csv_file = "csvfiles/Bonaire Scuba Shops 8.19.25.csv"
    output_file = "bonaire_import.sql"
    
    sql_statements = []
    sql_statements.append("-- Bonaire Dive Shops Import")
    sql_statements.append("-- Generated from: Bonaire Scuba Shops 8.19.25.csv")
...
if __name__ == "__main__":
    count = process_bonaire_csv()
    print(f"Processed {count} dive shops from Bonaire")
