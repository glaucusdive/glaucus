#!/usr/bin/env python3
"""
Process Belize dive shops CSV and generate SQL INSERT statements
"""
...
def process_belize_csv():
    """Process Belize CSV and generate SQL"""
    
    csv_file = "csvfiles/Belize Scuba Shops 8.19.25.csv"
    output_file = "belize_import.sql"
    
    sql_statements = []
    sql_statements.append("-- Belize Dive Shops Import")
    sql_statements.append("-- Generated from: Belize Scuba Shops 8.19.25.csv")
...
if __name__ == "__main__":
    count = process_belize_csv()
    print(f"Processed {count} dive shops from Belize")
