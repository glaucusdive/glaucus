#!/usr/bin/env python3
"""
Process Cayman Islands dive shops CSV and generate SQL INSERT statements
"""
...
def process_cayman_csv():
    """Process Cayman Islands CSV and generate SQL"""
    
    csv_file = "csvfiles/Cayman Scuba Shops 8.19.25.csv"
    output_file = "cayman_import.sql"
    
    sql_statements = []
    sql_statements.append("-- Cayman Islands Dive Shops Import")
    sql_statements.append("-- Generated from: Cayman Scuba Shops 8.19.25.csv")
...
if __name__ == "__main__":
    count = process_cayman_csv()
    print(f"Processed {count} dive shops from Cayman Islands")
