#!/usr/bin/env python3
"""
Process Turks and Caicos dive shops CSV and generate SQL INSERT statements
"""
...
def process_turks_caicos_csv():
    """Process Turks and Caicos CSV and generate SQL"""
    
    csv_file = "csvfiles/Turks and Caicos Scuba Shops 8.19.25.csv"
    output_file = "turks_caicos_import.sql"
    
    sql_statements = []
    sql_statements.append("-- Turks and Caicos Dive Shops Import")
    sql_statements.append("-- Generated from: Turks and Caicos Scuba Shops 8.19.25.csv")
...
if __name__ == "__main__":
    count = process_turks_caicos_csv()
    print(f"Processed {count} dive shops from Turks and Caicos")
