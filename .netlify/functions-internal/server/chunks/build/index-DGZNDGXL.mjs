...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({ name: "default" }, _attrs), {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="min-h-screen bg-zinc-50 h-full p-4"${_scopeId}> Profile </div>`);
      } else {
        return [
          createVNode("div", { class: "min-h-screen bg-zinc-50 h-full p-4" }, " Profile ")
        ];
      }
    }),
    _: 1
...
//# sourceMappingURL=index-DGZNDGXL.mjs.map
