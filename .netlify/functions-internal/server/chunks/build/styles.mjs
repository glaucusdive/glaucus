...
const styles = {
  "pages/index.vue": () => import('./index-styles.AfqI1orS.mjs').then(interopDefault),
  ...
  "pages/index.vue?vue&type=style&index=0&scoped=a251c34c&lang.css": () => import('./index-styles.DMnY_pZ5.mjs').then(interopDefault),
