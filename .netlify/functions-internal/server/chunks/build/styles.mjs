...
const styles = {
  "pages/index.vue": () => import('./index-styles.DDeHjzBQ.mjs').then(interopDefault),
  ...
  "pages/index.vue?vue&type=style&index=0&scoped=a4777d4f&lang.css": () => import('./index-styles.Bqt6U7St.mjs').then(interopDefault),
