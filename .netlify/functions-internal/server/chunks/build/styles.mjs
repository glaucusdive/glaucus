...
const styles = {
  "pages/index.vue": () => import('./index-styles.BZgpYAFa.mjs').then(interopDefault),
  ...
  "pages/index.vue?vue&type=style&index=0&scoped=ce314ddc&lang.css": () => import('./index-styles.CpNoZPGZ.mjs').then(interopDefault),
