...
import { X, CircleUser, LogIn, LogOut, Sun, Moon, CircleHelp, Star } from 'lucide-vue-next';
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const props = __props;
    const { updateLiveBookingPayloadIfOpen } = useDrawer();
    useSupabase();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</fieldset><hr class="border-zinc-300 dark:border-zinc-700"><h3 class="text-base font-bold px-2 text-zinc-900 dark:text-white">Diver Information</h3><fieldset class="bg-zinc-100 dark:bg-zinc-800 rounded-md flex flex-col gap-1 p-2 mx-2"><label for="numberOfDivers" class="text-xs uppercase font-medium px-2 text-zinc-900 dark:text-white">Number of Divers</label><input type="number" id="numberOfDivers"${ssrRenderAttr("value", formData.value.numberOfDivers)} min="1" required class="h-10 min-h-10 w-full rounded-sm px-2 py-0 text-sm leading-none outline-none hover:bg-zinc-200/50 dark:hover:bg-zinc-700/50 focus:bg-zinc-200 dark:focus:bg-zinc-700 bg-white dark:bg-zinc-900 text-zinc-900 dark:text-white"></fieldset><!--[-->`);
      ssrRenderList(formData.value.divers, (diver, index) => {
        _push(`<div class="bg-zinc-100 dark:bg-zinc-800 rounded-md flex flex-col gap-2 p-2 mx-2"><h3 class="text-xs uppercase font-medium px-2 text-zinc-900 dark:text-white">Diver ${ssrInterpolate(index + 1)}</h3><div class="flex flex-col gap-1"><label${ssrRenderAttr("for", `diver-name-${index}`)} class="text-xs px-2 text-zinc-600 dark:text-zinc-400">Name</label><input type="text"${ssrRenderAttr("id", `diver-name-${index}`)}${ssrRenderAttr("value", diver.name)} required class="h-10 min-h-10 w-full rounded-sm px-2 py-0 text-sm leading-none outline-none hover:bg-zinc-200/50 dark:hover:bg-zinc-700/50 focus:bg-zinc-200 dark:focus:bg-zinc-700 bg-white dark:bg-zinc-900 text-zinc-900 dark:text-white"></div><div class="flex flex-col gap-1"><label${ssrRenderAttr("for", `diver-cert-${index}`)} class="text-xs px-2 text-zinc-600 dark:text-zinc-400">Certification Number</label><input type="text"${ssrRenderAttr("id", `diver-cert-${index}`)}${ssrRenderAttr("value", diver.certificationNumber)} required class="h-10 min-h-10 w-full rounded-sm px-2 py-0 text-sm leading-none outline-none hover:bg-zinc-200/50 dark:hover:bg-zinc-700/50 focus:bg-zinc-200 dark:focus:bg-zinc-700 bg-white dark:bg-zinc-900 text-zinc-900 dark:text-white"></div><div class="flex flex-col gap-1"><label${ssrRenderAttr("for", `diver-dives-${index}`)} class="text-xs px-2 text-zinc-600 dark:text-zinc-400">Number of Dives Completed</label><input type="text"${ssrRenderAttr("id", `diver-dives-${index}`)}${ssrRenderAttr("value", diver.numberOfDives)} required class="h-10 min-h-10 w-full rounded-sm px-2 py-0 text-sm leading-none outline-none hover:bg-zinc-200/50 dark:hover:bg-zinc-700/50 focus:bg-zinc-200 dark:focus:bg-zinc-700 bg-white dark:bg-zinc-900 text-zinc-900 dark:text-white"></div><div class="flex gap-2 items-end"><div class="flex flex-col gap-1 flex-1 min-w-0"><label${ssrRenderAttr("for", `diver-height-${index}`)} class="text-xs px-2 text-zinc-600 dark:text-zinc-400">Height</label><input type="text"${ssrRenderAttr("id", `diver-height-${index}`)}${ssrRenderAttr("value", diver.height)} required class="h-10 min-h-10 w-full rounded-sm px-2 py-0 text-sm leading-none outline-none hover:bg-zinc-200/50 dark:hover:bg-zinc-700/50 focus:bg-zinc-200 dark:focus:bg-zinc-700 bg-white dark:bg-zinc-900 text-zinc-900 dark:text-white"></div><div class="flex flex-col gap-1 w-24 shrink-0"><label${ssrRenderAttr("for", `diver-height-unit-${index}`)} class="text-xs px-2 text-zinc-600 dark:text-zinc-400">Unit</label><select${ssrRenderAttr("id", `diver-height-unit-${index}`)} class="h-10 min-h-10 w-full rounded-sm px-2 py-0 text-sm leading-tight outline-none hover:bg-zinc-200/50 dark:hover:bg-zinc-700/50 focus:bg-zinc-200 dark:focus:bg-zinc-700 bg-white dark:bg-zinc-900 text-zinc-900 dark:text-white"><option value="ft-in"${ssrIncludeBooleanAttr(Array.isArray(diver.heightUnit) ? ssrLooseContain(diver.heightUnit, "ft-in") : ssrLooseEqual(diver.heightUnit, "ft-in")) ? " selected" : ""}>ft&#39; in&quot;</option><option value="cm"${ssrIncludeBooleanAttr(Array.isArray(diver.heightUnit) ? ssrLooseContain(diver.heightUnit, "cm") : ssrLooseEqual(diver.heightUnit, "cm")) ? " selected" : ""}>cm</option></select></div></div><div class="flex gap-2 items-end"><div class="flex flex-col gap-1 flex-1 min-w-0"><label${ssrRenderAttr("for", `diver-weight-${index}`)} class="text-xs px-2 text-zinc-600 dark:text-zinc-400">Weight</label><input type="text"${ssrRenderAttr("id", `diver-weight-${index}`)}${ssrRenderAttr("value", diver.weight)} required class="h-10 min-h-10 w-full rounded-sm px-2 py-0 text-sm leading-none outline-none hover:bg-zinc-200/50 dark:hover:bg-zinc-700/50 focus:bg-zinc-200 dark:focus:bg-zinc-700 bg-white dark:bg-zinc-900 text-zinc-900 dark:text-white"></div><div class="flex flex-col gap-1 w-24 shrink-0"><label${ssrRenderAttr("for", `diver-weight-unit-${index}`)} class="text-xs px-2 text-zinc-600 dark:text-zinc-400">Unit</label><select${ssrRenderAttr("id", `diver-weight-unit-${index}`)} class="h-10 min-h-10 w-full rounded-sm px-2 py-0 text-sm leading-tight outline-none hover:bg-zinc-200/50 dark:hover:bg-zinc-700/50 focus:bg-zinc-200 dark:focus:bg-zinc-700 bg-white dark:bg-zinc-900 text-zinc-900 dark:text-white"><option value="lbs"${ssrIncludeBooleanAttr(Array.isArray(diver.weightUnit) ? ssrLooseContain(diver.weightUnit, "lbs") : ssrLooseEqual(diver.weightUnit, "lbs")) ? " selected" : ""}>lbs</option><option value="kg"${ssrIncludeBooleanAttr(Array.isArray(diver.weightUnit) ? ssrLooseContain(diver.weightUnit, "kg") : ssrLooseEqual(diver.weightUnit, "kg")) ? " selected" : ""}>kg</option></select></div></div><div class="flex flex-col gap-2"><div class="flex items-center justify-between px-2"><label class="text-xs text-zinc-600 dark:text-zinc-400">Rental Gear</label><button type="button" class="text-xs bg-zinc-200 dark:bg-zinc-700 hover:bg-zinc-300 dark:hover:bg-zinc-600 px-3 py-1 rounded-sm font-medium cursor-pointer text-zinc-900 dark:text-white"> + Add Gear </button></div><!--[-->`);
        ssrRenderList(diver.gear, (gear, gearIndex) => {
          _push(`<div class="bg-white dark:bg-zinc-900 rounded-md flex flex-col gap-2 p-2 border border-zinc-200 dark:border-zinc-700"><div class="flex items-center justify-between"><span class="text-xs font-medium text-zinc-600 dark:text-zinc-400">Gear Item ${ssrInterpolate(gearIndex + 1)}</span><button type="button" class="text-xs text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 font-medium cursor-pointer"> Remove </button></div><div class="flex flex-col gap-1"><label${ssrRenderAttr("for", `diver-${index}-gear-type-${gearIndex}`)} class="text-xs text-zinc-600 dark:text-zinc-400">Gear Type</label><select${ssrRenderAttr("id", `diver-${index}-gear-type-${gearIndex}`)} required class="h-10 min-h-10 w-full rounded-sm px-2 py-0 text-sm leading-tight outline-none hover:bg-zinc-200/50 dark:hover:bg-zinc-700/50 focus:bg-zinc-200 dark:focus:bg-zinc-700 bg-zinc-100 dark:bg-zinc-800 text-zinc-900 dark:text-white"><option value=""${ssrIncludeBooleanAttr(Array.isArray(gear.gearType) ? ssrLooseContain(gear.gearType, "") : ssrLooseEqual(gear.gearType, "")) ? " selected" : ""}>Select gear type</option><!--[-->`);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(isMobileMenuOpen) || isDesktop.value) {
        ...
        _push(`</nav><div class="w-full h-12 p-0 shrink-0 flex flex-row gap-2 items-center">`);
        ...
        _push(ssrRenderComponent(_component_ClientOnly, null, {
          fallback: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="w-full h-full flex items-center justify-center border border-zinc-300 dark:border-zinc-800 rounded-full text-zinc-900 dark:text-white" aria-hidden="true"${_scopeId}>`);
...
//# sourceMappingURL=default-H4bKEOp6.mjs.map
