  <template>
    <div class="min-h-screen bg-gray-50 h-full">
      <div class="max-w-screen mx-auto h-full min-h-screen">
        <div class="bg-white h-full min-h-screen">
          ...
          <div class="h-full min-h-screen">
            ...
            <div v-else-if="diveshops && diveshops.length > 0" class="h-full min-h-screen">
              <div class="px-6 py-4 border-b border-gray-200 w-full max-w-screen">
              ...
              <div>
                <div class="w-full overflow-x-auto lg:overflow-x-visible">
                  <!-- Header -->
                  <div class="grid auto-cols-max grid-flow-col gap-4 px-6 py-3 bg-gray-50 sticky top-0 z-10">
                  ...
                  <div class="bg-white">
                    <div v-for="shop in diveshops" :key="shop.id"
                      class="grid auto-cols-max grid-flow-col gap-4 px-6 py-4 border-b border-gray-200 hover:bg-gray-50">
