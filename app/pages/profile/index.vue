<template>
  <NuxtLayout name="default">
    <div class="min-h-screen bg-zinc-50 dark:bg-zinc-900 h-full p-4">
      <h1 class="text-xl font-bold text-zinc-900 dark:text-white mb-4">Profile</h1>

      <section class="mb-8">
        <h2 class="text-lg font-semibold text-zinc-800 dark:text-zinc-200 mb-3">My drafts</h2>
