<template>
  <form class="flex flex-col gap-8 p-4 lg:p-6 max-w-3xl" @submit.prevent="onSubmit">
    <section class="flex flex-col gap-4">
      ...
      <FormField label="Sort order" field-id="blog-sort">
        <FormInput
          id="blog-sort"
    ...
    <section class="flex flex-col gap-4">
      ...
      <details class="rounded-lg border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-800 dark:bg-zinc-900/40">
        ...
        <dl class="mt-3 grid gap-2 text-sm text-zinc-600 dark:text-zinc-400">
          ...
          <div><dt class="font-mono text-xs text-zinc-500">![alt](url)</dt><dd>Image (use Upload inline image above)</dd></div>
    ...
    <div class="flex flex-wrap gap-2">
      ...
      <NuxtLink
        to="/admin/blog"
        class="rounded-md border border-zinc-300 px-4 py-2 text-sm font-medium text-zinc-800 hover:bg-zinc-100 dark:border-zinc-600 dark:text-zinc-200 dark:hover:bg-zinc-800"
      >
        Back to list
      </NuxtLink>
    </div>
