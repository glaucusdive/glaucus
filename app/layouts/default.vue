  ...
  <div class="h-screen w-screen overflow-hidden">
    <div class="h-full w-full flex flex-row">
      ...
      <div class="p-2 lg:pl-0 grow h-dvh w-dvw min-w-0 flex flex-row gap-2">
        ...
        <div class="w-96 h-full border border-gray-300 rounded-xl flex flex-col justify-start overflow-hidden">
          <div class="w-full p-1 border-b border-gray-300">
            <div class="w-full h-16 flex items-center justify-start px-2">
              <h2 class="text-xl font-medium">Book a Dive</h2>
            </div>
          </div>
          <div class="w-full h-full overflow-y-auto">
            <form @submit.prevent="handleSubmit" class="flex flex-col gap-2 relative pt-2">
              ...
              <div class="sticky bottom-0 bg-gray-50 border-t border-gray-300 p-2 mt-2">
                <button type="submit"
                  class="bg-gray-900 hover:bg-gray-800 text-white font-medium py-3 px-4 rounded-md transition-colors w-full">
