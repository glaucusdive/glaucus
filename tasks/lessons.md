...
- When runtime evidence shows a missing DB column, first confirm whether the product actually wants that column before treating an unapplied migration as the fix.
